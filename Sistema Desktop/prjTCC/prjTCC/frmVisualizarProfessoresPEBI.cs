...
namespace prjTCC
{
    public partial class frmVisualizarProfessoresPEBI : Form
    {
        public frmVisualizarProfessoresPEBI()
        {
            InitializeComponent();
        }
        ...
        private void frmVisualizarProfessoresPEBI_Load(object sender, EventArgs e)
        {
            ColocarDadosTabela();
        ...
        private void ColocarDadosTabela()
        {
            ...
            ListaProfessores = professores.BuscarProfessores(ETipoEnsino.PEBI);
