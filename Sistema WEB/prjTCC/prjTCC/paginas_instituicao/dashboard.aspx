<%@ Page Title="" Language="C#" MasterPageFile="~/paginas_instituicao/Instituicao.Master" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="prjTCC.instituicao.dashboard" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="areaConteudoInferior" runat="server">
    ...
    <script src="../js/scriptDashboardInstituicao.js"></script>
</asp:Content>
