<%@ Page Title="" Language="C#" MasterPageFile="~/paginas_instituicao/Instituicao.Master" AutoEventWireup="true" CodeBehind="atribuicaoPEBI.aspx.cs" Inherits="prjTCC.paginas_instituicao.atribuicaoPEBI" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="areaConteudoInferior" runat="server">
    ...
    <asp:Panel ID="pnlAtribuicao" runat="server">
         <div class="areaConteudo">
            <div class="InicioTitulo tituloPEBI" id="Aguardando">
    ...
    <%--                    <tr>
            ...
            <asp:Button ID="btnChamar" runat="server" Text="Iniciar" onClick="btnChamar_Click" CssClass="botaoChamar"/>
        </div>
        <div class="areaConteudo">
    ...
    <section id="areaAtribuirProfessor" class="areaPopUp escondido" >
        ...
        <div class='botao' id="areaBtnConfirmaAtribuidor">
            <asp:Button ID="btnAtribuir" runat="server" Text="Atribuir" onClick="btnAtribuir_Click" CssClass="botaoChamar"/>
        </div>
    </section>
...
<asp:Content ID="Content5" ContentPlaceHolderID="codigoJS" runat="server">
    ...
    <asp:Literal ID="litScriptPageLoad" runat="server"></asp:Literal>
