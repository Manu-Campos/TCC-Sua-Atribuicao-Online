<%@ Page Title="" Language="C#" MasterPageFile="~/paginas_instituicao/Instituicao.Master" AutoEventWireup="true" CodeBehind="andamentoProfessorEspecifico.aspx.cs" Inherits="prjTCC.paginas_instituicao.andamentoProfessorEspecifico" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="../css/estiloAndamento.css">
    <link href="../css/estiloAndamentoEspecifico.css" rel="stylesheet" />
    <title>Professor Atribuído</title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="areaConteudoInferior" runat="server">
    <div id="divVoltar">
        ...
        <div>
            <h1 class="tituloPagina">Professor</h1>
        ...
        <div id="infoProfessor">
            ...
            <div>
                ...
                <div id="infoEscola">
                    ...
                    <p>Escola sede: <asp:Literal ID="litEscolaSede" runat="server"></asp:Literal></p>
                </div>
            </div>
        </div>
