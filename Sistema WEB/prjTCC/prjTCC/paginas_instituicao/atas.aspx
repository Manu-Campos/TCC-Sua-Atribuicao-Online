<%@ Page Title="" Language="C#" MasterPageFile="~/paginas_instituicao/Instituicao.Master" AutoEventWireup="true" CodeBehind="atas.aspx.cs" Inherits="prjTCC.instituicao.atas" %>
        ...
        <div class="tabelaFixa">
            <table class="tabelaAtas">
                <thead>
                    <tr>
                        <th>\</th>
                        <th class="Inicio" id="Arquivo">Arquivo</th>
                        <th>Ano</th>
                        <th>Tipo</th>
...
<%--                    <tr id="linhaTabela">
    ...
    <section class="escondido areaPopUp">
        <h2>Relatório enviado ao RH com sucesso!</h2>
    </section>
</asp:Content>
