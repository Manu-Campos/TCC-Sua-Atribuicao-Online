...
{
    public partial class buscarNotificacoesInstituicao : System.Web.UI.Page
    {
            ...
            try
            {
                if (Request["i"] != null)
                {
                    if (!String.IsNullOrEmpty(Request["i"].ToString()))
                    {
                        ...
                        List<NotificacaoSistema> ListaAvisos = avisos.ListarNotificacoesPorIinstituicao(Session["logado"].ToString(), inicio, inicio + 30);
