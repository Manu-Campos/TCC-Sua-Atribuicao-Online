...
document.addEventListener("DOMContentLoaded", function () {
    fetch('../lib/buscarPorcentagemFasesInstituicao.aspx')
        .then(response => {
...
document.addEventListener("DOMContentLoaded", function () {
    fetch('../lib/andamentoDashboardInstituicao.aspx')
        .then(response => {
            return response.json();
        })
        .then(data => {
            if (data['erro']) {
                ...
                const disciplinas = data.map(item => item.disciplina);
    ...
    fetch('../lib/buscarPorcentagemFasesInstituicao.aspx')
        ...
        .then(data => {
            if (data.erro) {
                ...
                fetch('../lib/professoresDashboardInstituicao.aspx')
                    .then(response => response.json())
                    .then(data => {
                        if (data.erro) {
                            console.log(data.erro);
