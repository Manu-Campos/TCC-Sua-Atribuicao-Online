...
namespace prjTCC.atribuidor
{
    public partial class atribuicaoPEBI : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //if (int.Parse(Session["codigoProfessor"].ToString()) != 0)
            //{
            //    int codigoProfessor = int.Parse(Session["codigoProfessor"].ToString());
            //    Atribuicoes atribuicoes = new Atribuicoes();
            //    situacao = atribuicoes.verificarSituacaoAtribuicaoProfessor(codigoProfessor);
            ...
            //    {
            //        litAguardando.Text = "<p class='SemMargin cmdLinha'>O tempo para atribuição das suas aulas foi excedido! <img src='../imagens/icones/aviso.png'></p>";
            //    }
            //}
        }
    }
