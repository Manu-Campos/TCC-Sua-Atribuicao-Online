...
<%@ Page Title="" Language="C#" MasterPageFile="~/paginas_professor/Professor.Master" AutoEventWireup="true" CodeBehind="configuracoes.aspx.cs" Inherits="prjTCC.paginas_professor.configuracoes" %>
        ...
        <div class="areaConteudo" id="areaDados">
            <div class="linhaDados">
                <div class="txtNome">
                    ...
                    <asp:TextBox ID="txtNome" runat="server" CssClass="Txts" Enabled="false" ></asp:TextBox>
                </div>
                <div class="txtTelefone">
                    <p class="Labels SemMargin">Telefone:</p>
                    <asp:TextBox ID="txtTelefone" runat="server" CssClass="Txts txtTelefoneC" TextMode="Phone"></asp:TextBox>
                </div>
            </div>
             <div class="linhaDados">
                  <div class="txtEmail">
                    <p class="Labels SemMargin">E-mail:</p>
                    <asp:TextBox ID="txtEmail" runat="server" CssClass="Txts" TextMode="Email" Enabled="false"></asp:TextBox>
                </div>
                <div class="txtDataN">
                    <p class="Labels SemMargin">Data de nascimento:</p>
                    <asp:TextBox ID="txtDataN" runat="server" CssClass="Txts" TextMode="Date" Enabled="false"></asp:TextBox>
                </div>
                   <div class="txtProntuario">
                    <p class="Labels SemMargin">Prontuário:</p>
                    <asp:TextBox ID="txtProntuario" runat="server" CssClass="Txts" TextMode="Number" Enabled="false" ></asp:TextBox>
                </div>
            </div>
            <div class="linhaDados">
